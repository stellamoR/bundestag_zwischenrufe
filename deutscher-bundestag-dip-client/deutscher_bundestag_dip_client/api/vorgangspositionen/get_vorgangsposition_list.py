...
from ...models.get_vorgangsposition_list_f_dokumentart import GetVorgangspositionListFDokumentart
from ...models.get_vorgangsposition_list_format import GetVorgangspositionListFormat
from ...models.vorgangsposition_list_response import VorgangspositionListResponse
...
def _get_kwargs(
    *,
    f_aktivitaet: Union[Unset, int] = UNSET,
    ...
    f_dokumentart: Union[Unset, GetVorgangspositionListFDokumentart] = UNSET,
    ...
    f_vorgang: Union[Unset, int] = UNSET,
    ...
    format_: Union[Unset, GetVorgangspositionListFormat] = GetVorgangspositionListFormat.JSON,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}

    params["f.aktivitaet"] = f_aktivitaet
...
) -> Optional[Union[Any, VorgangspositionListResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = VorgangspositionListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, VorgangspositionListResponse]]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        f_datum_end (Union[Unset, datetime.date]): Liefert das Datum eines Dokuments (Drucksache
            oder Protokoll).
        f_dokumentart (Union[Unset, GetVorgangspositionListFDokumentart]):
        ...
        format_ (Union[Unset, GetVorgangspositionListFormat]):  Default:
            GetVorgangspositionListFormat.JSON.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, VorgangspositionListResponse]
    """
