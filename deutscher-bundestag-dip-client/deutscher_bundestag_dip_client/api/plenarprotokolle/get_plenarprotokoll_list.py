...
from ...models.get_plenarprotokoll_list_format import GetPlenarprotokollListFormat
from ...models.plenarprotokoll_list_response import PlenarprotokollListResponse
...
def _get_kwargs(
    *,
    ...
    format_: Union[Unset, GetPlenarprotokollListFormat] = GetPlenarprotokollListFormat.JSON,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
) -> Optional[Union[Any, PlenarprotokollListResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PlenarprotokollListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, PlenarprotokollListResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        format_ (Union[Unset, GetPlenarprotokollListFormat]):  Default:
            GetPlenarprotokollListFormat.JSON.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, PlenarprotokollListResponse]
    """
