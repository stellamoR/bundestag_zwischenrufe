...
from ...models.drucksache_list_response import DrucksacheListResponse
from ...models.get_drucksache_list_format import GetDrucksacheListFormat
...
def _get_kwargs(
    *,
    ...
    format_: Union[Unset, GetDrucksacheListFormat] = GetDrucksacheListFormat.JSON,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
) -> Optional[Union[Any, DrucksacheListResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = DrucksacheListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, DrucksacheListResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        format_ (Union[Unset, GetDrucksacheListFormat]):  Default: GetDrucksacheListFormat.JSON.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, DrucksacheListResponse]
    """
